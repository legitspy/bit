         ...
         <>
            ...
            <div className="space-y-3 bg-gray-800 p-4 rounded-lg">
                ...
                <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-white">{parseFloat(amount).toFixed(8)} BTC</span>
                </div>
                 <div className="flex justify-between">
                    <span className="text-gray-400">Fee</span>
                    <span className="font-semibold text-white">{fee.toFixed(8)} BTC</span>
                </div>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="text-right">
                        ...
                        {isRateLoading ? (
                             <div className="h-4 flex items-center justify-end text-xs text-gray-400">
                                <Spinner size="sm" />
                                <span className="ml-2">Fetching rate...</span>
                            </div>
                        ) : btcToUsdRate ? (
                             <p className="text-xs text-gray-400 h-4">~ ${(totalDeduction * btcToUsdRate).toFixed(2)} USD</p>
                        ) : (
