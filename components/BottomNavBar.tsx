...
const BottomNavBar: React.FC<BottomNavBarProps> = ({ onSendClick, onReceiveClick }) => {
    ...
    return (
        <>
            <div 
                className="fixed bottom-0 left-0 right-0 bg-black/80 backdrop-blur-lg border-t border-gray-800 z-40"
                style={{ height: `calc(70px + env(safe-area-inset-bottom))` }}
            >
                <div className="flex justify-around items-center h-[70px] max-w-7xl mx-auto px-4">
